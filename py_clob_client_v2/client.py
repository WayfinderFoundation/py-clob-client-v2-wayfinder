...
class ClobClient:
    ...
    async def _l1_headers(self, nonce: Optional[int] = None) -> dict:
        self.assert_level_1_auth()
    ...
    async def create_api_key(self, nonce: Optional[int] = None) -> ApiCreds:
    ...
    async def derive_api_key(self, nonce: Optional[int] = None) -> ApiCreds:
        headers = await self._l1_headers(nonce=nonce)
    ...
    async def create_or_derive_api_key(self, nonce: Optional[int] = None) -> ApiCreds:
        try:
